...
# Try importing ollama_utils, but don't fail if Ollama is unavailable
try:
    ...
    def display_deepseek_response(answer, model, container):
...
# Try importing ollama functions, but don't fail if unavailable
try:
